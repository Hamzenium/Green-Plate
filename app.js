...
app.post('/create/recipe', async (req, res) => {
    ...
    try {
        ...
        if (userDoc.exists) {
            ...
            const prompt = `Based on your what sort of food I want to eat (${preference_word}) and available items in the fridge (${items_word}), list only 5 to 10 healthy recipes in json format seperated by comma.`;
